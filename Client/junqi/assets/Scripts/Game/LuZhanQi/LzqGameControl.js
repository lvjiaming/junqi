    ...
    createMap() {
        ...
        if (this._game) {
            ...
            if (this._game.bianJie) {
                ...
                this._game.bianJie.rect(cc.winSize.width/2 - cc.lzqGameCfg.MAT_SIZE.W/2, cc.winSize.height/2 - cc.lzqGameCfg.MAT_SIZE.H/2, cc.lzqGameCfg.MAT_SIZE.W, cc.lzqGameCfg.MAT_SIZE.H);
